...
# (istenirse gazetteer'den il/ilçe isim setleri de eklenebilir)
# from gazetteer import IL_NAMES, ILCE_NAMES_BY_IL
        ...
        for field, val in items.items():
            ...
            for (il, ilce), cnt in bucket.items():
                ...
                if il_hint and il and il.lower() != il_hint.lower():
                    continue
                if ilce_hint and ilce and ilce.lower() != ilce_hint.lower():
                    continue
